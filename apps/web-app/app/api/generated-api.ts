...
export interface RetryReviewResponse {
  data: {
    /** @format uuid */
    id: string;
    userId: string;
 ...
 * @contact
 *
 * Code Review as a Service: upload code, get prioritised static + AI review findings
 */
export class API<
...
> extends HttpClient<SecurityDataType> {
  api = {
     ...
     *
     * @tags Reviews
     * @name ReviewsControllerCreateReviewV1
     * @request POST:/api/v1/reviews
     */
    reviewsControllerCreateReviewV1: (
      data: {
        title?: string;
      ...
      this.request<CreateReviewResponse, any>({
        path: `/api/v1/reviews`,
        method: "POST",
        body: data,
        type: ContentType.FormData,
     ...
     *
     * @tags Reviews
     * @name ReviewsControllerListReviewsV1
     * @request GET:/api/v1/reviews
     */
    reviewsControllerListReviewsV1: (params: RequestParams = {}) =>
      this.request<ListReviewsResponse, any>({
        path: `/api/v1/reviews`,
        method: "GET",
        format: "json",
        ...params,
     ...
     *
     * @tags Reviews
     * @name ReviewsControllerGetStatsV1
     * @request GET:/api/v1/reviews/stats
     */
    reviewsControllerGetStatsV1: (params: RequestParams = {}) =>
     ...
     *
     * @tags Reviews
     * @name ReviewsControllerGetReviewV1
     * @request GET:/api/v1/reviews/{id}
     */
    reviewsControllerGetReviewV1: (id: string, params: RequestParams = {}) =>
      this.request<GetReviewResponse, any>({
     ...
     *
     * @tags Reviews
     * @name ReviewsControllerDeleteReviewV1
     * @request DELETE:/api/v1/reviews/{id}
     */
    reviewsControllerDeleteReviewV1: (id: string, params: RequestParams = {}) =>
      this.request<DeleteReviewResponse, any>({
        path: `/api/v1/reviews/${id}`,
        method: "DELETE",
        format: "json",
        ...params,
     ...
     *
     * @tags Reviews
     * @name ReviewsControllerRetryReviewV1
     * @request POST:/api/v1/reviews/{id}/retry
     */
    reviewsControllerRetryReviewV1: (id: string, params: RequestParams = {}) =>
      this.request<RetryReviewResponse, any>({
