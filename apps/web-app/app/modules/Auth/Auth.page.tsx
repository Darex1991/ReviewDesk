    ...
    <div className={cn("flex flex-col gap-6")}>
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
          ...
          <div className="relative hidden flex-col items-center justify-center gap-6 bg-gradient-to-br from-primary/15 via-muted to-background p-10 text-center md:flex">
            <img src="/brand.svg" alt="ReviewDesk" className="size-20 text-primary" />
            <div className="space-y-2">
              <p className="text-xl font-semibold">ReviewDesk</p>
              <p className="max-w-xs text-sm text-muted-foreground">
                Upload a repository, get a prioritised list of findings from static analysis
                and an AI reviewer.
              </p>
            </div>
          </div>
